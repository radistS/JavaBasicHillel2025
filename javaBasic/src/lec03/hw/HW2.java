...
public class HW2 {
    public static void main(String[] args) {
        int orderNumber1 = 1;
        System.out.print("Order No " + orderNumber1 + " ");
        ...
        System.out.println("Price EUR" + priceSmartphone + ".");
        String adressAlice = "Moon Street, 10";
        System.out.println("Adress:" + adressAlice + ".");
        int orderNumber2 = 21;
        System.out.print("Order No" + orderNumber2 + " ");
        ...
        System.out.println("Price EUR " + priceLaptop + ".");
        String adressTom = "Terra Street, 17";
        System.out.println("Address"  + adressTom);}
}
